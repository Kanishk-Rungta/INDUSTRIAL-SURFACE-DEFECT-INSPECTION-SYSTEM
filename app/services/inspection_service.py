...
CAPTURE_MAX_BYTES = 20 * 1024 * 1024  # compatibility constant; settings are authoritative
...
def portable_media_path(raw: str | None, settings: Settings | None = None) -> str | None:
    ...
    roots = (
        (settings.runtime_data_dir, ""), (settings.bundled_data_dir, ""),
        (settings.source_dir, "sources"), (settings.overlay_dir, "overlays"),
        (settings.batch_dir, "batches"), (settings.export_dir, "exports"),
    )
